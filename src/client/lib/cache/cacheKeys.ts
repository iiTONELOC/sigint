...
export const CACHE_KEYS = {
  ...
  /** @deprecated Per-device presets — merged into layoutPresetsShared */
  layoutPresetsDesktop: `sigint.layout.presets.desktop.${V}`,
  /** @deprecated Per-device presets — merged into layoutPresetsShared */
  layoutPresetsMobile: `sigint.layout.presets.mobile.${V}`,
  layoutPresetsShared: `sigint.layout.presets.shared.${V}`,
...
> = {
  ...
  [CACHE_KEYS.airports]: { label: "Airport coordinates", group: "Data" },
  ...
  [CACHE_KEYS.layoutPresetsDesktop]: { label: "Desktop presets (legacy)", group: "UI" },
  [CACHE_KEYS.layoutPresetsMobile]: { label: "Mobile presets (legacy)", group: "UI" },
  [CACHE_KEYS.layoutPresetsShared]: { label: "Layout presets", group: "UI" },
