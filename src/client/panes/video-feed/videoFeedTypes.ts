...
export function getRegion(country: string): RegionKey {
  ...
  const americas = new Set([
    "CA", "MX", "BR", "AR", "CL", "CO", "PE", "VE", "EC", "CU", "DO", "PR",
    "PA", "CR", "GT", "HN", "SV", "NI", "BO", "PY", "UY", "JM", "TT", "HT",
  ]);
  const europe = new Set([
    "GB", "UK", "FR", "DE", "IT", "ES", "PT", "NL", "BE", "AT", "CH", "SE",
    "NO", "DK", "FI", "PL", "CZ", "SK", "HU", "RO", "BG", "HR", "RS", "SI",
    "BA", "GR", "CY", "IE", "IS", "LT", "LV", "EE", "UA", "BY", "MD", "AL",
    "ME", "MK", "XK", "MT", "LU",
  ]);
  const mideast = new Set([
    "AE", "SA", "QA", "KW", "BH", "OM", "IQ", "IR", "SY", "LB", "JO", "PS",
    "IL", "YE", "EG", "LY", "TN", "DZ", "MA",
  ]);
  const asia = new Set([
    "CN", "JP", "KR", "IN", "PK", "BD", "LK", "NP", "MM", "TH", "VN", "PH",
    "MY", "SG", "ID", "KH", "LA", "TW", "HK", "MN", "KZ", "UZ", "KG", "TJ",
    "TM", "AF", "GE", "AM", "AZ", "TR",
  ]);
  const africa = new Set([
    "NG", "KE", "ZA", "GH", "ET", "TZ", "UG", "CI", "CM", "SN", "CD", "ML",
    "BF", "NE", "MZ", "MG", "AO", "ZW", "RW", "SD", "SS", "SO", "ER", "DJ",
    "MW", "ZM", "BW", "NA",
  ]);
