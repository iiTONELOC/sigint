...
} from "@/domain/providers/base/types";
import { generateMockAircraft } from "@/data/mockData";
import { getSquawkStatus } from "@/lib/aircraft/aircraftUtils";
import { getAircraftMetadataBatch } from "@/lib/aircraft/aircraftTypeLookup";
